...
br_list2 <- list(br_lnc, "br", "prot")
lp_list1 <- list(lp_lnc, "lp", "lnc")
lp_list2 <- list(lp_lnc, "lp", "prot")
te_list1 <- list(te_lnc, "te", "lnc")
te_list2 <- list(te_lnc, "te", "prot")
ov_list1 <- list(ov_lnc, "ov", "lnc")
ov_list2 <- list(ov_lnc, "ov", "prot")
ve_list1 <- list(ve_lnc, "ve", "lnc")
ve_list2 <- list(ve_lnc, "ve", "prot")
gi_list1 <- list(gi_lnc, "gi", "lnc")
gi_list2 <- list(gi_lnc, "gi", "prot")
